...
"Nie jestem wielką agencją. Jestem pasjonatem."
Strona prezentuje ofertę freelancera, który podchodzi do każdego projektu indywidualnie, dbając o detale i "duszę" strony.

## Oferta

*   **Nowa Strona:** Tworzenie lekkich, statycznych stron typu wizytówka.
*   **Poprawki i Modernizacja:** Odświeżanie wyglądu, dostosowanie do urządzeń mobilnych (RWD).
*   **Social Media Ready:** Konfiguracja meta tagów (Open Graph) dla atrakcyjnego wyglądu linków na Facebooku.

## Standard Techniczny

Moje realizacje opierają się na nowoczesnych standardach:

*   📱 **PWA (Progressive Web App):** Strony działają jak aplikacje natywne (szybkość, offline, instalacja na telefonie).
*   🚀 **SEO i Social Media:** Pełna optymalizacja pod wyszukiwarki.
*   ✨ **Interaktywność:** Płynne animacje i nowoczesne formularze bez przeładowania strony.
...
Przykładowe realizacje wymienione na stronie:
*   Projekt Społeczny: **Referendum**
*   Wizytówka Firmowa: **Paweł Szczęsny - Usługi**
*   Budownictwo: **Prodom**
